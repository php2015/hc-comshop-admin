...
class Transport_SnailFishShopModel
{
    ...
    public function calc_transport($transport_id, $quantity, $buy_num, $area_id) {
		...
		$shipping_param[':uniacid'] = $_W['uniacid'];
		$shipping_param[':id'] = $transport_id;
		
		$shipping_sql = "select * from ".tablename('lionfish_comshop_shipping')." where uniacid=:uniacid and id=:id ";
	...
	private function calc_unit($area_id, $quantity, $weight, $extend){		
		...
		$area_sql = "select * from ".tablename('lionfish_comshop_area')." where id=:id ";
